...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 10:08:44 2021
...
#Load data
file_phasemore=np.load('../collectedData/CollectResults_phaseLongMoreNew.npz')
...
#Save figure
fig.savefig('./output/Fig5AllNew.eps',dpi=300,bbox_inches='tight',bbox_extra_artist=[legF])

...
file2=np.load('../collectedData/coincidenceSpindles/SWSlong-seed-5-phase-0.00-decreaseRamp-F0.85-A3.46e+01-D1.00e-01-sdA-OFF-sdF-OFF-pF0.02-pR2.00-Phi.txtSpindlesCoincidenceLong.npz')
file3=np.load('../collectedData/coincidenceSpindles/SWSlong-seed-5-phase-0.79-decreaseRamp-F0.85-A3.46e+01-D1.00e-01-sdA-OFF-sdF-OFF-pF0.02-pR2.00-Phi.txtSpindlesCoincidenceLong.npz')
file4=np.load('../collectedData/coincidenceSpindles/SWSlong-seed-5-phase-1.57-decreaseRamp-F0.85-A3.46e+01-D1.00e-01-sdA-OFF-sdF-OFF-pF0.02-pR2.00-Phi.txtSpindlesCoincidenceLong.npz')
...
fig6.savefig('./output/Fig6.eps',dpi=300,bbox_inches='tight',bbox_extra_artist=[leg1])
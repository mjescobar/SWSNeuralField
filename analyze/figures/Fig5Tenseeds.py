...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 10:18:20 2021
...
#Load data
file_phasemore=np.load('../collectedData/CollectResults_phaseLongMore.npz')
collect_Iso_phasemore=file_phasemore['collect_Iso']
collect_Ispindles_phasemore=file_phasemore['collect_Ispindles']
collectr_Iso_phasemore=file_phasemore['collectr_Iso']
collectr_Ispindles_phasemore=file_phasemore['collectr_Ispindles']
collect_pc_phasemore=file_phasemore['collect_pc']
collect_pcp_phasemore=file_phasemore['collect_pcp']
collect_pso_phasemore=file_phasemore['collect_pso']
collect_psp_phasemore=file_phasemore['collect_psp']
collect_coincidences_phasemore=file_phasemore['collect_coincidences']
collect_so_phasemore=file_phasemore['collect_so']
collect_spindles_phasemore=file_phasemore['collect_spindles']
collectr_pc_phasemore=file_phasemore['collectr_pc']
collectr_pcp_phasemore=file_phasemore['collectr_pcp']
collectr_pso_phasemore=file_phasemore['collectr_pso']
collectr_psp_phasemore=file_phasemore['collectr_psp']
collectr_coincidences_phasemore=file_phasemore['collectr_coincidences']
collectr_so_phasemore=file_phasemore['collectr_so']
collectr_spindles_phasemore=file_phasemore['collectr_spindles']
y_axis_phasemore=[0,45,90]
labels_phasemore=['0','45','90']
labels_stimphase=['STIM-CL 0','STIM-CL 45','STIM-CL 90']

collect_Iso_phase=np.vstack((collect_Iso_phase,collect_Iso_phasemore))
collect_Ispindles_phase=np.vstack((collect_Ispindles_phase,collect_Ispindles_phasemore))
collect_pc_phase=np.vstack((collect_pc_phase,collect_pc_phasemore))
collect_pcp_phase=np.vstack((collect_pcp_phase,collect_pcp_phasemore))
collect_pso_phase=np.vstack((collect_pso_phase,collect_pso_phasemore))
collect_psp_phase=np.vstack((collect_psp_phase,collect_psp_phasemore))
collect_so_phase=np.vstack((collect_so_phase,collect_so_phasemore))
collect_spindles_phase=np.vstack((collect_spindles_phase,collect_spindles_phasemore))
collect_coincidences_phase=np.vstack((collect_coincidences_phase,collect_coincidences_phasemore))
...
#Save figure
fig.savefig('./output/Fig5All.eps',dpi=300,bbox_inches='tight',bbox_extra_artist=[legF])
